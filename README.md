...
*Doing it natively with the App makes it much simpler than messing about making a  text box editable and  hype projects. These can be buggy when used in w webview on a device and zoom the view most often which is annoying and ugly.*

---



When you tap a box's outer Group. ( to edit )
...
The App will receive the edit message and will
